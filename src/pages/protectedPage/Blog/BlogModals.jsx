    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className={`text-2xl font-bold ${theme.colors.text}`}>Add New Blog Post</h2>
          <button
            onClick={handleClose}
...
const EditModal = ({ showEdit, handleCloseEdit, editData, handleEditInputChange, editTechInput, setEditTechInput, handleAddEditTechnology, handleRemoveEditTechnology, editErrors, handleUpdate, updateBlogReducerLoading, theme }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className={`text-2xl font-bold ${theme.colors.text}`}>Edit Blog Post</h2>
          <button
            onClick={handleCloseEdit}
            className={`p-2 rounded-lg ${theme.colors.surfaceSecondary} ${theme.colors.textMuted} hover:${theme.colors.text}`}
          >
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <motion.button
            ...
            className="px-6 py-3 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white font-semibold rounded-lg transition-colors"
          >
            {updateBlogReducerLoading ? "Updating..." : "Update Post"}
          </motion.button>
        </div>
      </motion.div>
    </motion.div>
...
const DeleteModal = ({ showDelete, handleCloseDelete, handleDelete, deleteBlogReducerLoading, theme }) => {
